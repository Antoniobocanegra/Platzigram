...
module.exports = function pictureCard(pic) {
  ...
  function render(picture) {
    return yo(_templateObject, pic.liked ? 'liked' : '', picture.url, picture.user.username, picture.user.avatar, picture.user.username, moment(picture.createdAt).fromNow(), like.bind(null, true), like.bind(null, false), picture.likes);
  }
